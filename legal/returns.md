<!-- Slug: returns — Título: Returns & Refunds -->

# Returns & Refunds

Last updated: [data]

Every OurMoment piece is made to order, personalized with your names, dates
...
1. Your order number
2. Photographs clearly showing the problem
3. A photograph of the shipping label, if the packaging was damaged

We do not usually ask you to ship the item back — for print-on-demand it is
cheaper for everyone if you keep or dispose of the faulty piece.

## Order changes and cancellations

You can change or cancel your order **within [2] hours of placing it**, before
it enters production. Email us immediately at [contact@ourmoment.com] with
your order number.

After production starts we cannot cancel, because the item is already being
printed with your personalization.
