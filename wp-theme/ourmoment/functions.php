...
add_action('wp_enqueue_scripts', function () {
    ...
    wp_enqueue_style('ourmoment-style', get_stylesheet_uri(), ['astra-parent'], '1.13.0');
    wp_enqueue_script('ourmoment-js', get_stylesheet_directory_uri() . '/assets/js/main.js', [], '1.13.0', true);
});
